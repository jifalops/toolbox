...
public abstract class AbsTextReaderWriter {
    static final String TAG = AbsTextReaderWriter.class.getSimpleName();
                ...
                protected List<String> doInBackground(Void... params) {
                    ...
                    synchronized (file) {
                        try {
                            ...
                            ioe = e;
                            Log.e(TAG, "readLines error: " + e.getMessage());
                        } finally {
                            try {
                                if (r != null) r.close();
                            } catch (IOException e) {
            ...
            protected Integer doInBackground(Void... params) {
                ...
                synchronized (file) {
                    try {
                        ...
                        ioe = e;
                        Log.e(TAG, "writeLines error: " + e.getMessage());
                    } finally {
                        try {
                            if (w != null) w.close();
                        } catch (IOException e) {
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... params) {
                ...
                try {
                    ...
                    ioe = e;
                    Log.e(TAG, "truncate error: " + e.getMessage());
                } finally {
                    try {
                        if (w != null) w.close();
                    } catch (IOException e) {
